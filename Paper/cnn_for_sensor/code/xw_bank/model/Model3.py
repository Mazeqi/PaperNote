...
class Model(nn.Module):
    def __init__(self, num_classes=19):
        ...
        self.conv1 = nn.Sequential(
           nn.Conv1d(1, base_channel, 3, stride=1, padding = 1), 
           ...
           nn.Conv1d(base_channel * 4, base_channel * 8, 3, stride=1, padding = 1), 
           nn.BatchNorm1d(base_channel * 8), 
           nn.ReLU(inplace=True),
        )

        self.conv1_2 = nn.Sequential(
            nn.Conv2d(base_channel * 8, base_channel * 8, kernel_size=(3, 3),stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(base_channel * 8),
            nn.ReLU(inplace=True),

            nn.Conv2d(base_channel * 8, base_channel * 4, kernel_size=(1, 1)),
        ...
        self.conv2 = nn.Sequential(
            # 1
            nn.Conv2d(base_channel, base_channel, kernel_size=(3, 3),stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(base_channel),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(2,2),
            ...
            nn.Conv2d(base_channel * 4, base_channel*8,kernel_size=(3, 3), stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(base_channel*8),
            nn.ReLU(inplace=True),
            ...
            nn.Conv2d(base_channel * 8, base_channel*16,kernel_size=(3, 3), stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(base_channel*16),
            nn.ReLU(inplace=True),

            nn.Conv2d(base_channel * 16, base_channel*8, kernel_size=(1, 1)),
            nn.BatchNorm2d(base_channel*8),
            nn.ReLU(inplace=True),
        ...
        self.classier = nn.Linear(base_channel*16, num_classes)
    ...
    def forward(self, img):
        ...
        x = self.conv1(x)
        x = x.reshape(img.shape[0], base_channel * 8, 60, 8)
        x = self.conv1_2(x)
