...
class defect_patch_set(Dataset):

    def __init__(self, transform = None, label_bg_path = ['defect_patch_data/3_background/black.jpg', 'defect_patch_data/3_background/blue.jpg']):
        
        self.transform = transform
        self.label_bg_path = label_bg_path
        
        self.img_files_0 = glob.glob('defect_patch_data/3_black/' + '*.jpg')
        self.img_files_1 = glob.glob('defect_patch_data/3_blue/' + '*.jpg')
